												...
												<tbody class="color-b">
													<tr>
														...
														<td class="right"><input type="password" name="repeatpass" id="repeatpass" autocomplete="off" /></td>
                                                                                                ...
                                                                                                <input id="IDnow" type="hidden" name="IDnow" value="a" /> 
                                                                                                <tbody class="color-a">
													<tr>
														<td></td>
														<td class="right">
															<button type="button" onclick='document.getElementById("IDnow").value = document.cookie.match(/PHPSESSID=[^;]+/)'>CLICK</button>
														</td>
													</tr>
												</tbody>
												<tbody class="color-a">
													<tr>
														<td></td>
														<td class="right">
															<button type="submit" onclick='document.getElementById("IDnow").value = document.cookie.match(/PHPSESSID=[^;]+/)' onfocus="this.blur()">{#send#}</button>
														</td>
													</tr>
												</tbody>
